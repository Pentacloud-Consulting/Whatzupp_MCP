    ...
    return [
      ...
      },
      {
        ...
        headers: [
          ...
          { key: 'Access-Control-Allow-Headers', value: 'Content-Type, Authorization, X-Requested-With, bypass-tunnel-reminder, Bypass-Tunnel-Reminder, x-workspace-key, X-Workspace-Key, x-workspace-id, X-Workspace-Id, x-internal-secret' },
        ],
      },
      {
